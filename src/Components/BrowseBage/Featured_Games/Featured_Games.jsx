...
export default function Featured_Games(Props) {
  ...
  return (
    <div className="Featured_Games" data-aos="zoom-in-right"  data-aos-duration="500" data-aos-delay="200">
      ...
      >
        <Slider {...settings}>
          <Card
            img="./Browse/Featured_Games/featured-01.jpg"
            title="cs-go"
            rating="4.8"
          ...
          />
          <Card
            img="./Browse/Featured_Games/featured-02.jpg"
            title="cs-go"
            rating="4.8"
            download_text="249K Download"
            download="2.4m"
          />
          <Card
            img="./Browse/Featured_Games/featured-03.jpg"
            title="cs-go"
            rating="4.8"
            download_text="249K Download"
            download="2.4m"
